...
public abstract class Conta {		/*	cap10.6.1)para servir como “modelo” para outras classes que dela herdem,
									não podendo ser instanciada por si só	
									
										cap10.6.2)economizar um pouco de codigo e ganha polimorfismo 
									para criar métodos mais genéricos, que se encaixem a diversos objetos	*/
	int numero;
